...
namespace DJNANO
{
    ...
    {
        private Guid APP_ID = new Guid("f079a57d-fb37-4e31-be1b-212a20dbe380");
        ...
        private void UpdateAppTiles()
        {
            ...
            if (init == null || (init is bool && !(bool)init))
            {
                ...
                tiles.Add("f904a108d0ec88ff", "DataImages/Tile1.jpg");
                tiles.Add("f904a108d0ec8900", "DataImages/Tile2.jpg");
                tiles.Add("f904a108d0ec8901", "DataImages/Tile3.jpg");
                tiles.Add("f904a108d0ec8902", "DataImages/Tile4.jpg");
                tiles.Add("f904a108d0ec8903", "DataImages/Tile5.jpg");
