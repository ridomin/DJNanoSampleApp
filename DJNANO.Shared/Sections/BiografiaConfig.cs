...
{
    public class BiografiaConfig : SectionConfigBase<LocalStorageDataConfig, HtmlSchema>
    {
        ...
        public override LocalStorageDataConfig Config
        {
            get
            {
                ...
                {
                    FilePath = "/Assets/Data/Biografia.htm"
                };
            }
        }
        ...
        public override NavigationInfo ListNavigationInfo
        {
            get 
            {
                return NavigationInfo.FromPage("BiografiaListPage");
            }
        }
