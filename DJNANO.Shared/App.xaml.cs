...
using DJNANO.Services;

#if WINDOWS_APP
using Windows.System;
using Windows.UI.Core;
using Windows.UI.ApplicationSettings;
using DJNANO.AppFlyouts;
#endif
...
namespace DJNANO
{
    ...
    {
        private Guid APP_ID = new Guid("817d0baf-4b9c-4b0f-894f-2210734bd402");
        public const string APP_NAME = "DJ NANO";
        ...
        private void UpdateAppTiles()
        {
            ...
            if (init == null || (init is bool && !(bool)init))
            {
                ...
                tiles.Add("78cb8e01502d6ec9", "DataImages/Tile1.jpg");
                tiles.Add("78cb8e01502d6eca", "DataImages/Tile2.jpg");
                tiles.Add("78cb8e01502d6ecb", "DataImages/Tile3.jpg");
                tiles.Add("78cb8e01502d6ecc", "DataImages/Tile4.jpg");
                tiles.Add("78cb8e01502d6ecd", "DataImages/Tile5.jpg");
